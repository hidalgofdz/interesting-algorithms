import { exponentialSearchLocation } from "./exponential-search-location"
...
test.each([
  ...
  { list: listOfNumbers, target: 130, expected: 129 },
  ...
  ({ list, target, expected }) => {
    const result = exponentialSearchLocation(list, target)
